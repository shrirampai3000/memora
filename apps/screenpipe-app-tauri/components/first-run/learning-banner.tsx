...
const EMPTY_COPY: Record<FirstRunEmptyReason, string> = {
  ...
  unknown:
    "Nothing was captured in that window. Memora keeps reading in the background as you work.",
};
      ...
      {phase === "learning" && (
        <div className="flex flex-col gap-2">
          ...
          <p className="text-[11px] leading-relaxed text-muted-foreground">
            ...
            summary of what Memora picked up shows up in a new chat.
          </p>
