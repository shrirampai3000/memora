...
const ShortcutSection = () => {
  ...
  const handleRestoreDefaults = async () => {
    try {
      ...
      try { await commands.showShortcutReminder(defaults.showMemoraShortcut); } catch (_) {}
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        <ShortcutRow type="global" shortcut="showMemoraShortcut" title="toggle memora overlay" description="show/hide the main interface" value={settings.showMemoraShortcut} />
