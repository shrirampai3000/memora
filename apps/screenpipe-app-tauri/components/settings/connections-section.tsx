...
function ClaudeCodePanel() {
  ...
  const cmd = "claude mcp add memora -- npx -y screenpipe-mcp@latest";
...
export function ConnectionsSection({
  ...
  useEffect(() => {
    ...
    fetch(memoraWebUrl("/api/composio/status", "https://screenpipe.com"), {
