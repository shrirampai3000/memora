...
const ACCOUNT_URL = memoraWebUrl("/account", "https://screenpipe.com");
const BILLING_URL = memoraWebUrl("/account/billing", "https://screenpipe.com");
...
function syncErrorDescription(e: unknown): string {
  ...
  if (/load failed|failed to fetch|networkerror|network request failed/i.test(msg)) {
    return "memora server isn't reachable — give it a few seconds after launch and try again";
  }
  return msg;
}
              ...
              <div className="flex items-center gap-3">
                ...
                {settings.pipeSyncEnabled && (
                  <Button
                    ...
                    title={
                      isServerDown
                        ? "memora server is starting up — try again in a moment"
                        : undefined
                    }
