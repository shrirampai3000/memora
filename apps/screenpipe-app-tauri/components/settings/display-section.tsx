...
export function DisplaySection() {
  ...
  // re-render) so we never fire two overlapping memora restarts.
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        {/* Disable Timeline / rewind. Gates timeline-only backend work
            ...
            unlike the other display toggles it needs a full memora restart
                  ...
                  try {
                    ...
                    try {
                      ...
                      toast({
                        ...
                        description: "memora restarted to apply the change.",
                      });
                    } catch (e) {
                      toast({
                        title: "failed to restart memora",
                        description: "restart memora manually to apply the change.",
                        variant: "destructive",
                      });
                    }
                  } finally {
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                    ...
                    <HelpTooltip text="When enabled, the memora overlay can appear in OBS or Screen Studio. The broader 'Hide memora from screen capture' preference in Audio & meetings takes priority." />
                  </h3>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-foreground flex items-center gap-1.5">
                      Hide Dock Icon
                      <HelpTooltip text="Run memora as a menu-bar-only app with no icon in the Dock. The menu-bar (tray) icon stays — click it to open screenpipe. Useful if you only need the app occasionally and don't want it in the Dock." />
                    </h3>
                    <p className="text-xs text-muted-foreground">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    toast({
                      ...
                      description: checked
                        ? "Click the tray icon to bring memora back."
                        : undefined,
                    });
                  }}
                />
