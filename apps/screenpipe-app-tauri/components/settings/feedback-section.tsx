    ...
    <div className="space-y-5" data-testid="section-help">
      ...
      <div className="space-y-2">
        ...
        <button
          ...
          onClick={() => open(memoraWebUrl("/survey?utm_source=app&utm_medium=help", "https://screenpipe.com"))}
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(memoraWebUrl("/ideas", "https://screenpipe.com"))}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(memoraWebUrl("/changelog", "https://screenpipe.com"))}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
