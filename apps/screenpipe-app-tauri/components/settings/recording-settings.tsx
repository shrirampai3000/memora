                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="screenpipe-cloud">
                        Memora Cloud{hwCapability?.recommendedEngine === "screenpipe-cloud" && " ★"}
                      </SelectItem>
                ...
                {(settings.meetingLiveTranscriptionEnabled ?? true) && (
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="screenpipe-cloud">memora cloud live</SelectItem>
