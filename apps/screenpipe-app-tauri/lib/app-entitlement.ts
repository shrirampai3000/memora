...
export const PRICING_URL = memoraWebUrl("/onboarding", "https://screenpipe.com");
export const ENTERPRISE_BUILDS_URL = memoraWebUrl("/enterprise?tab=builds", "https://screenpipe.com");
export const ENTERPRISE_DOWNLOAD_URL = memoraWebUrl("/api/download", "https://screenpipe.com");
