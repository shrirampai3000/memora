...
export type AecMode = "off" | "memora" | "macos" | "windows";
...
const AEC_MODES = new Set<AecMode>(["off", "memora", "macos", "windows"]);
...
export function buildDesktopRemoteControlPatch(
  ...
  if (
    ...
    Boolean(settings.memoraAecEnabled) !==
      aecSettings.memoraAecEnabled ||
