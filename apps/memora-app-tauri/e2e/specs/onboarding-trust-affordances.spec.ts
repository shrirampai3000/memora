...
(canRun ? describe : describe.skip)(
  ...
  function () {
    ...
    // â”€â”€â”€ login slide: the only universal reach â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    it("keeps the login promises device-neutral", async () => {
      ...
      expect(note).not.toMatch(/âŒ˜|ctrl\+|alt\+|super\+/);
    });
    ...
    (isMac ? describe : describe.skip)("on macOS", function () {
      ...
      it("collapses the trust line by default and proves the real path on expand", async () => {
        ...
        // hardcoded ~/.MEMORA passes every mock and fails right here.
        ...
        expect(await textOfTestId("onboarding-pause-detail")).toContain(
          "pause recording anytime from the MEMORA icon",
        );
    ...
    // â”€â”€â”€ timeline slide: where the capture decision is made â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    //
