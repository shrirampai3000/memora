 ...
 *      + plugin:e2e|emit_agent_stream so isLoading flips true â†’ false naturally).
...
describe.skip("Chat switch context loss (issue #3636 / PR #3600)", function () {
  ...
  it("does not write chat A's messages into chat B's file when user switches mid-stream", async () => {
    // â”€â”€ Step 1: Open chat A, seed a user message, stream a fake reply â”€â”€
    ...
    // â”€â”€ Step 3: Verify no cross-contamination on disk â”€â”€
