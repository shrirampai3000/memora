...
// behaviour but means a regression in the "fresh install â†’ onboarding
...
(canRun ? describe : describe.skip)(
  ...
  function () {
    ...
    it("renders the login slide content, not a loading spinner or blank shell", async () => {
      ...
      expect(bodyText).toContain("MEMORA");
      expect(bodyText).toContain("ai finally knows what you");
    });

    // â”€â”€â”€ system-browser login handoff â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    //
