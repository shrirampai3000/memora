...
(canRun ? describe : describe.skip)("First-run onboarding UX", function () {
  ...
  // â”€â”€â”€ setup slides â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

  it("opens setup on a fresh install", async () => {
    const url = new URL(await browser.getUrl());
    expect(url.pathname).toBe("/onboarding");
    expect(await bodyText()).toContain("MEMORA");
  });
  ...
  it("reaches the acquisition slide in the shipped slide order", async () => {
    ...
    await waitForBodyText("how did you find MEMORA");
  ...
  it("embeds card capture as the final onboarding screen", async () => {
    ...
    const text = await bodyText();
    expect(text).toContain("add a payment method to keep MEMORA business");
