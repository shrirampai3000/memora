...
//
// Runs under `MEMORA_E2E_SEED=onboarding,no-recording`, the authenticated
...
// webview and resolves the REAL home directory: `MEMORA_E2E_AI_TOOLS_HOME`
