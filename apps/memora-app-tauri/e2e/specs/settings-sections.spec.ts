 ...
 *
 * home/page.tsx â†’ data-testid="settings-nav-{section.id}" on every sidebar button
 *
 * Happy paths:
...
describe('Settings sections', () => {
  ...
  // â”€â”€â”€ Happy paths â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  it('keeps audio and meeting notes separate and applies screen-share privacy live', async () => {
    ...
    expect(sectionText).toContain('hide MEMORA from screen capture');
  ...
  // â”€â”€â”€ Recent regressions / new features (covered as smoke tests) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  //
  ...
  it('keeps the low-disk guard on by default, preserves explicit opt-out, and stops capture when enabled', async () => {
    ...
    try {
      ...
      expect(notification?.actions).toContainEqual({
        ...
        type: 'deeplink',
        url: 'MEMORA://settings?section=storage',
        primary: true,
      });
  ...
  // â”€â”€â”€ Negative: backend health check failure â†’ graceful degradation â”€â”€â”€â”€â”€â”€â”€â”€

  it('page stays alive and crash-free after a failed backend API call', async () => {
    // We cannot kill the MEMORA backend in e2e, but we can verify the UI
