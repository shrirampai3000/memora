...
const FORCE_ENTERPRISE_BUILD_KEY = 'MEMORA_e2e_force_enterprise_build';
const POLICY_KEY = 'MEMORA_e2e_enterprise_policy';
const HEARTBEAT_STATUS_KEY = 'MEMORA_e2e_enterprise_heartbeat_status';
const SKIP_SAVED_LICENSE_KEY = 'MEMORA_e2e_enterprise_skip_saved_license';
...
let localApiPort = Number(process.env.MEMORA_PORT ?? '3030');
let localApiAuthHeaders = authHeaders(process.env.MEMORA_API_KEY ?? null);
