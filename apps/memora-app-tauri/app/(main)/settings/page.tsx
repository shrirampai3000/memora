...
function SettingsContent() {
  ...
  // keyboard-highlighted row (â†‘â†“ navigate, Enter picks).
  ...
  // âŒ˜K / Ctrl+K focuses the search input. Scoped to the settings page via this
  ...
  useEffect(() => {
    const handler = (e: KeyboardEvent) => {
      ...
      // Don't hijack âŒ˜K while the user is typing in another field (e.g. the
