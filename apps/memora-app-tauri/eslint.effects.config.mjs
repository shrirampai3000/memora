...
// config run via `bun run lint:effects` â€” it does NOT replace `.eslintrc.json`
...
// follow-up once Phases 1â€“3 have cleared the backlog.
...
export default [
  {
    ...
    // exist in these files as "unused" â€” this config doesn't enable them.
    ...
    rules: {
      ...
      // state-sync smell â€” buckets A/B/C). Formerly
