...
// â”€â”€â”€ isNotificationsDenied â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Round-trip tests â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
describe("round-trip: disable then enable", () => {
  const cases = [
    ...
    },
    {
      ...
      input:
        "---\nschedule: '*/30 15-23,0-3 * * *'\nenabled: true\npreset:\n  - MEMORA-cloud\nconnections:\n  - obsidian\nhistory: false\npermissions:\n---\n\nSync memora activity to an Obsidian vault",
    },
    {
  ...
  for (const { name, input } of cases) {
    ...
    it(`${name}: disable â†’ enable â†’ body content preserved`, () => {
      const disabled = toggleNotificationInContent(input, false);
      const reenabled = toggleNotificationInContent(disabled, true);
...
Sync memora activity to an Obsidian vault`;
    ...
    expect(reenabled).toContain("Sync memora activity");
  });
});
