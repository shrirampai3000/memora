...
${"This is a long sentence about memora memory rendering. ".repeat(20)}`);
...
**Relationship:** memora core contributor
...
- [ ] reply on Discord`,
    ...
    expect(display.subtitle).toBe("memora core contributor");
