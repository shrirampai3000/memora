...
describe("formatNextRun", () => {
  ...
  test("absent or unparseable â†’ null so callers can fall back", () => {
...
describe("humanizeDow", () => {
  test("empty / wildcard â†’ empty", () => {
    expect(humanizeDow("")).toBe("");
    expect(humanizeDow("*")).toBe("");
  });

  test("all seven days â†’ daily", () => {
