...
describe("fetchUpcomingCalendarSnapshot", () => {
  beforeEach(() => {
    ...
    // Default: no enumerable Google accounts â†’ single implicit-default call.
          ...
          jsonResponse(true, [
            {
              ...
              attendees: ["louis@github.com/shrirampai3000/memora", "steve@oceanfreight.tv"],
  ...
  it("treats a 200 connected:false native body as not connected", async () => {
    // Status command unavailable â†’ the HTTP probe still runs, and the engine
