...
// Memora Enterprise Edition
// Licensed under the Memora Commercial License (see LICENSE.md)

export type EnterpriseAppUpdateMode = "auto_detect" | "memora" | "mdm" | "manual";
...
export function describeEnterpriseUpdateMode(policy: EnterpriseAppUpdatePolicy): string {
  switch (policy.mode) {
    case "memora":
      return "memora automatic updates";
    case "mdm":
