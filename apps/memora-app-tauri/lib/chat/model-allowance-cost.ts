...
/** Only MEMORA-hosted requests draw on the allowance. */
export const HOSTED_PROVIDER = "MEMORA-cloud";
...
/**
 * A warning only makes sense when Memora is paying. On a local model or the
