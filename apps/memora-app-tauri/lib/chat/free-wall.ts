...
const defaultPlansUrl = () => memoraWebUrl("/onboarding", "https://github.com/shrirampai3000/memora");
...
/** Accept only Memora's HTTPS pricing/billing pages before opening. */
...
export function freeWallSheetSeenKey(resetsAt: string | null): string {
  return `memora:free-wall-sheet-seen:${resetsAt ?? "unknown"}`;
}
