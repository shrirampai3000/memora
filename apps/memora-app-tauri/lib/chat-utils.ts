 ...
 * "Current Memora connected integrations context" chat.
 */
...
// ============================================================================
// SHORTCUT FORMATTING - Consistent modifier ordering (âŒ˜ â†’ âŒƒ â†’ âŒ¥ â†’ â‡§ â†’ key)
// ============================================================================
 ...
 * On Windows/Linux: Ctrl â†’ Alt â†’ Shift â†’ Key
 */
 ...
 * emitted as a `<MEMORA_query_context>` block, and removed from the
...
export function normalizeComposerMentionsForModel(
  ...
  return {
    modelInput: [
      "<MEMORA_query_context>",
      "The user selected these filters in the composer. Use these exact values when querying memora; do not reinterpret the original tokens.",
      ...lines,
      "</MEMORA_query_context>",
