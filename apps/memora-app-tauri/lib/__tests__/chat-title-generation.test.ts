...
// â”€â”€â”€ stripPromptPlumbing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
describe("stripPromptPlumbing", () => {
  ...
  it("removes the <MEMORA-large-context> offload wrapper", () => {
    expect(
      stripPromptPlumbing(
        "<MEMORA-large-context>\n[INPUT OFFLOADED]\nfull_path: /tmp/full.txt\n</MEMORA-large-context>\n\nSummarize this"
      )
    ).toBe("Summarize this");
  });
...
// â”€â”€â”€ systemFallbackTitle â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
describe("systemFallbackTitle", () => {
  ...
  it("returns cleaned content slice for wrapper + real content", () => {
    const content =
      "<role>You are an expert</role> Create a custom memora automation";
    expect(systemFallbackTitle(content)).toBe(
      "Create a custom memora automation"
    );
  });
  ...
  it("returns the content itself if it starts with 'new chat' text", () => {
    // A message that literally says "new chat" â†’ fallback is "new chat"
...
// â”€â”€â”€ deriveFallbackConversationTitle â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
describe("deriveFallbackConversationTitle", () => {
  it("prefers displayContent over raw prompt text", () => {
    expect(
      deriveFallbackConversationTitle({
        ...
        content: "search memora for what happened during this meeting and summarize it",
      })
  ...
  it("falls back to cleaned prompt text when no displayContent exists", () => {
    expect(
      deriveFallbackConversationTitle({
        content: "<role>expert</role> Create a custom memora automation",
      })
    ).toBe("Create a custom memora automation");
  });
...
// â”€â”€â”€ isFallbackLikeTitle â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Integration: first-turn-only + race protection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
