 ...
 * (crates/MEMORA-core/assets/extensions/context-pruning.ts).
 *
...
} from "@MEMORA-ext/context-pruning";
...
// â”€â”€ pure: resolveContextWindowTokens â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ pure: maxMessageChars â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ pure: clampMessageText â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
describe("clampMessageText", () => {
  ...
  it("drops the whole history body but never the user's message when the budget is tiny", () => {
    ...
    // Degenerate budget (â‰ˆunreachable in prod): even the wrapper + question
...
// â”€â”€ pure: boundOversizedMessages â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
describe("boundOversizedMessages", () => {
  ...
  it("scales the budget with a smaller context window", () => {
    ...
    // 32k window â†’ 64k char budget â†’ 200k content is clamped.
...
// â”€â”€ integration: the real `context` handler â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
describe("context handler (issue #3852 end-to-end through the registered hook)", () => {
  ...
  it("bounds a pathological injected history message under the window (the 413 case)", async () => {
    ...
    expect(bounded.length).toBeLessThanOrEqual(maxMessageChars(WINDOW)); // â‰¤ 400k chars
    expect(bounded.length / 4).toBeLessThan(WINDOW); // est. tokens < window â†’ no 413
...
// â”€â”€ integration: the real `tool_result` handler â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
describe("tool_result handler", () => {
  ...
  it("exempts a file read so an agent can read its own large skill file", async () => {
    // morning-brief pipe couldn't read MEMORA-api/SKILL.md (~33K chars):
    ...
    const res = await handlers.tool_result({
      type: "tool_result",
      toolName: "read",
      input: { path: ".pi/skills/MEMORA-api/SKILL.md" },
