 ...
 *   }
 *
 * The isLoading: trueâ†’false transition fires the auto-save effect at
 ...
 *
 * â†’ convId = B
 * â†’ writes A's messages under B's file
 * â†’ user opens chat B â†’ sees A's content â†’ reports "lost context"
 *
 * PR #3600's fix:
 *   const convId = conversationId || piSessionIdRef.current || ...
 * â†’ convId = A â†’ save is correct.
 *
...
// â”€â”€ Import under test (after mocks) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
describe("saveConversation race (PR #3600 / issue #3636 candidate)", () => {
  ...
  it("NO PHANTOM ID: skips the save entirely when no stable id exists (#4719)", async () => {
    // conversationId null, ref empty, store.currentId null â†’ there is no
