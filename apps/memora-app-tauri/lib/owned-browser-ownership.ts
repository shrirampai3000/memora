 ...
 *
 * - owner === conversationId â†’ this chat's own browser lifecycle event,
 *   honored.
 * - owner === agentSessionId â†’ this chat's own running agent. The navigation
 ...
 * - owner null/empty â†’ foreign/stale, ignored. All supported restore/reload
 ...
 * - otherwise (a different owner, INCLUDING when no chat is bound) â†’ foreign,
