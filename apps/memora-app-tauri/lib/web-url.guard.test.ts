...
const PROD_ORIGIN = /https:\/\/(www\.)?(memora\.com|screenpi\.pe)/;
const HELPER_CALL = /MEMORAWeb(Url|Base)\s*\(/;
...
describe("no hardcoded prod website origins outside the web-url helpers", () => {
  it("every https://github.com/shrirampai3000/memora|github.com/shrirampai3000/memora literal is a helper fallback or a comment", () => {
