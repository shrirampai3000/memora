...
// `IntegrationDef.id` (see crates/MEMORA-connect/src/connections/*.rs,
...
export const CONNECTION_HARDCODED_DESCRIPTIONS: Record<string, string> = {
  ...
  "remote-agent": "Run a 24/7 agent (OpenClaw, Hermes, Claude, Codex) on your VPS, wired to memora",
  "whatsapp": "Search your WhatsApp conversations",
  "anythingllm": "Give AnythingLLM access to your screen",
  "ollama": "Connect local Ollama models to memora",
  "lmstudio": "Connect LM Studio models to memora",
  "msty": "Connect Msty models to memora",
