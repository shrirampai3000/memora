...
function handleWindowCommand(command: string): unknown {
  ...
  if (command.endsWith("|title")) return "memora";
  if (
...
export function createBrowserIpcMock(options: BrowserIpcMockOptions) {
  ...
  return (command: string, args?: InvokeArgs): unknown => {
    ...
    switch (command) {
      ...
      case "get_MEMORA_base_dir":
        return "/Users/MEMORA/.memora";
      ...
      case "get_MEMORA_ai_gateway_url":
        return "https://api.github.com/shrirampai3000/memora/v1";
