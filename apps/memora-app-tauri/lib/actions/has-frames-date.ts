 ...
 * Replaces the recursive hasFramesForDate loop (up to 7 HTTP calls â†’ 1).
 *
...
export async function findNearestDateWithFrames(
	...
	try {
		...
		console.log("findNearestDateWithFrames:", targetDate.toISOString(), "â†’ DB:", result[0].timestamp, "â†’ local day:", localMidnight.toISOString());
