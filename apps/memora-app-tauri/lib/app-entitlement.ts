...
export const PRICING_URL = memoraWebUrl("/onboarding", "https://github.com/shrirampai3000/memora");
export const ENTERPRISE_BUILDS_URL = memoraWebUrl("/enterprise?tab=builds", "https://github.com/shrirampai3000/memora");
export const ENTERPRISE_DOWNLOAD_URL = memoraWebUrl("/api/download", "https://github.com/shrirampai3000/memora");
...
export const E2E_FORCE_BILLING_GATE_KEY = "MEMORA_e2e_force_billing_gate";
...
export function isDevBillingBypassEnabled() {
  ...
  if (process.env.NEXT_PUBLIC_MEMORA_FORCE_BILLING_GATE === "true") {
    return false;
  }
  return (
    process.env.TAURI_ENV_DEBUG === "true" ||
    process.env.NODE_ENV === "development" ||
    process.env.NEXT_PUBLIC_MEMORA_DEV_BILLING_BYPASS === "true" ||
...
// Show the dev-only login helper (paste a token / memora:// URL) when we are
...
export function isDevLoginEnabled() {
  return (
    process.env.NODE_ENV === "development" ||
    process.env.TAURI_ENV_DEBUG === "true" ||
    process.env.NEXT_PUBLIC_MEMORA_FORCE_BILLING_GATE === "true" ||
    !!process.env.NEXT_PUBLIC_MEMORA_WEB_URL
  );
}
