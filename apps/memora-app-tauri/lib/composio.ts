...
export const COMPOSIO_API = memoraWebUrl("/api/composio", "https://github.com/shrirampai3000/memora");
...
export async function authorizeComposioToolkit(
  ...
  if (response.status === 404) {
    throw new Error(
      "this connection isn't available yet â€” update memora and try again"
    );
  }
