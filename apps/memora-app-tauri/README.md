...
usage documentation is available at [docs.github.com/shrirampai3000/memora](https://docs.github.com/shrirampai3000/memora/getting-started).
...
| telemetry | on | off |
| agent MCP configs (`~/.claude`, `~/.codex`, â€¦) | real home | empty fake home |
...
port 3030 â€” mid-write to a multi-GB SQLite database.
...
# so testing them needs the production port. Quit the installed app first â€”
