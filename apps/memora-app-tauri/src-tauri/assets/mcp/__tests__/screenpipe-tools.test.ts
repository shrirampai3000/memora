...
// The bundled MCP server is what gives every ACP harness the MEMORA tools.
...
const SERVER = join(dirname(fileURLToPath(import.meta.url)), "..", "MEMORA-tools.mjs");
...
describe("MEMORA-tools MCP server", () => {
  let server: Server;
