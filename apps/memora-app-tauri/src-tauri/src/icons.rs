...
/// Strip dots, dashes, underscores and spaces so "github.com/shrirampai3000/memora" matches "MEMORA",
...
async fn get_exe_from_potential_path(app_name: &str) -> Option<String> {
    ...
    // Try %LOCALAPPDATA% first â€” Electron apps (Slack, Discord, etc.) install here
...
/// for an app *before* it has ever been captured â€” paired with `get_app_icon`,
