...
//
// Results travel back to Rust through `document.title` â€” the only channel
...
//                   full JSON. base64 keeps every chunk title-safe â€” no
...
(function () {
    ...
    // UTF-8 safe base64 of a JS string â€” snapshots contain non-ASCII (e.g. â†’ ).
