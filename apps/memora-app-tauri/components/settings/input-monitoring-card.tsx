 ...
 * Settings â†’ Permissions share the same enable/reset path.
 */
      ...
      {suspectedGhost && !granted ? (
        <div className="rounded-md border border-red-500/30 bg-red-500/5 px-3 py-2">
          <p className="text-xs text-red-700 dark:text-red-400">
            ...
            <strong> memora </strong> on in System Settings â†’ Privacy &amp;
            Security â†’ Input Monitoring. If the toggle is already on but
      ...
      {grantedThisSession ? (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/5 px-3 py-2">
          <p className="text-xs text-amber-700 dark:text-amber-400">
            <strong>Restart memora</strong> to start capturing keystrokes
