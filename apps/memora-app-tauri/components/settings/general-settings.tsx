...
export default function GeneralSettings() {
  ...
  const handleAutoStartChange = async (checked: boolean) => {
    ...
    try {
      ...
      toast({
        ...
        description: checked
          ? "memora will start in the background when you log in"
          : "memora won't launch at startup",
      });
    } catch (e: any) {
      handleSettingsChange({ autoStartEnabled: !checked });
      toast({
  ...
  const handleOpenVersions = async () => {
    ...
    const url = memoraWebUrl(`${path}?${params.toString()}`, "https://github.com/shrirampai3000/memora");
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {isManagedDeployment
                      ...
                      : "Open recent stable versions on github.com/shrirampai3000/memora"}
                  </p>
                </div>
              </div>
              <Button
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  What you want memora to help you accomplish
                </p>
              </div>
            </div>
            <Select
