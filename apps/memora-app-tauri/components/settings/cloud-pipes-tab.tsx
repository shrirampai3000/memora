...
export function CloudPipesTab({ active }: { active: boolean }) {
  ...
  if (cloud.error === "no_license") {
    return (
      <EmptyState
        ...
        body="cloud scheduled tasks run your org's managed tasks on memora infrastructure. activate your enterprise license first, then come back here."
      />
    );
  }
  ...
  // â”€â”€ no runner yet â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (!cloud.runner) {
    return (
      <EmptyState
              ...
              {showAiKeyInput ? (
                <>
                  <Input
                    ...
                    placeholder="api key for AI scheduled tasks (MEMORA_API_KEY on the vm)"
