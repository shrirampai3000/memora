...
export function PrivacySection() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Memora has been restarted with new settings",
      });
    } catch (error) {
  ...
  //
  //   usePiiRemoval            â†’ hot-path regex (MEMORA-core)
  ...
  // (see `RedactColumns` in MEMORA-redact). The core keys are always
    ...
    try {
      ...
      if (
        ...
        toast({
          ...
          description: "allow memora to control your browser in macOS Automation settings",
          variant: "destructive",
        });
        return;
      }
 ...
 * `read:search` / `read:records` scopes that the `MEMORA-team` pi
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                ...
                <button
                  ...
                  onClick={() =>
                    openUrl(memoraWebUrl("/enterprise?tab=tokens", "https://github.com/shrirampai3000/memora"))
                  }
                >
                  github.com/shrirampai3000/memora/enterprise â†’ api tokens
                </button>
                .
              </p>
            </div>
