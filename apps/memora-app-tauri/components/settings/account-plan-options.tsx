...
/**
 * Every self-serve plan, shown inline in Settings â†’ Account.
 *
 ...
 * `plan: "pro"`, so a user who wanted Basic had no way to choose it â€” and a
 ...
 *  billing page for proration, so they deep-link with the target preset â€”
...
// (60 â†’ 120 â†’ 240 in usage-tracker's DEFAULT_TIER_CONFIG). Say that, so nobody
...
export const ACCOUNT_PLANS: PlanRow[] = [
  {
    ...
    monthly: 0,
    cadence: "/ month",
    points: ["10 AI credits / month Â· Auto only", "limited history"],
    cta: "included",
    purchase: null,
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      "frontier Claude + GPT Â· cloud sync",
    ],
    cta: "choose business",
