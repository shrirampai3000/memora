    ...
    <div className="space-y-5" data-testid="section-help">
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              the complete memora tutorial, setup to scheduled tasks
            </p>
          </div>
        ...
        <button
          ...
          onClick={() => open(memoraWebUrl("/survey?utm_source=app&utm_medium=help", "https://github.com/shrirampai3000/memora"))}
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-sm font-medium text-foreground">Shape memora</h3>
                <p className="text-xs text-muted-foreground">90-second survey â€” tell us what&apos;s working and what&apos;s not</p>
              </div>
            </div>
            <span className="text-xs text-muted-foreground group-hover:text-foreground transition-colors duration-150 shrink-0">
              take survey â†’
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open("https://docs.github.com/shrirampai3000/memora")}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              docs.github.com/shrirampai3000/memora â†’
            </button>
          </div>
        </div>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(memoraWebUrl("/ideas", "https://github.com/shrirampai3000/memora"))}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              github.com/shrirampai3000/memora/ideas â†’
            </button>
          </div>
        </div>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open("https://github.com/MEMORA/MEMORA/issues")}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              open â†’
            </button>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              onClick={() => open("https://discord.com/invite/MEMORA")}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              join â†’
            </button>
        ...
        <div className="px-3 py-2.5 bg-card border border-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => open(memoraWebUrl("/changelog", "https://github.com/shrirampai3000/memora"))}
              className="text-xs text-muted-foreground hover:text-foreground transition-colors duration-150"
            >
              github.com/shrirampai3000/memora/changelog â†’
            </button>
          </div>
        </div>
