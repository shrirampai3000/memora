    ...
    <Dialog open={Boolean(pending)}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            {pending
              ? `${labelBrowser(pending.browser)} wants to connect to Memora. This lets agents use your open tabs when browser context is needed.`
              : "A browser wants to connect to Memora."}
          </DialogDescription>
        </DialogHeader>
