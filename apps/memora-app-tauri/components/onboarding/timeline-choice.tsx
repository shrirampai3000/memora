...
// MEMORA_config::DeviceTier::as_str() ("high" / "mid" / "low").
...
// â”€â”€â”€ Lite in-UI preview â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
//
  ...
  return (
    ...
    >
      ...
      <div className="relative h-6 border-t border-border/50 bg-background">
        ...
        {/* playhead sweeps right â†’ left: scrubbing back in time */}
        <div
...
// â”€â”€â”€ Cost explanation rows â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
/**
 * Restart memora if it is already running, so a choice made on an
 * onboarding replay reaches the live recorder.
 *
 * Both flags are read at spawn, and engine-startup skips spawning when /health
 * already reports a live engine (tray â†’ "Reset Onboarding" while recording).
 ...
 * stop â†’ wait â†’ spawn sequence in components/settings/display-section.tsx.
 *
...
function restartRunningEngine(): void {
  void (async () => {
    ...
    try {
      ...
      console.error("failed to restart memora after timeline choice:", e);
