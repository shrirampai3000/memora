...
export default function FirstRunGuide({
  ...
  // Single watcher: ASK â†’ streaming â†’ automate
  //
  ...
  useEffect(() => {
    const check = (state: ReturnType<typeof useChatStore.getState>) => {
      ...
      // streaming â†’ automate: debounce idle to survive inter-tool gaps
  ...
  // The guide used to render `send â†µ` as a button-shaped span. Submit the
        ...
        >
          ...
          >
            ...
            <p className="font-sans text-sm text-foreground/90 leading-snug">
              want to see how memora works? one prompt, one automation,
              about 30 seconds.
            </p>
            <button
