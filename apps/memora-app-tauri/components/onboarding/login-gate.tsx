...
// â”€â”€â”€ background canvas â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ button inner canvas (geometry on hover) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const OnboardingLogin: React.FC<OnboardingLoginProps> = ({
  ...
  const handleLogin = useCallback(() => {
    ...
    // comes back on the memora:// deep link; nothing is typed by hand.
        ...
        {isLoggedIn ? (
          ...
          >
            <span className="font-mono text-xs text-foreground/80">
              âœ“ signed in as {settings.user?.email || "user"}
            </span>
          </motion.div>
        ) : awaitingBrowser ? (
