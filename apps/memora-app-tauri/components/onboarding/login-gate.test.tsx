...
describe("onboarding login gate", () => {
  ...
  it("tells every platform that recording can be paused", () => {
    ...
    expect(locality.textContent ?? "").not.toMatch(/âŒ˜|ctrl|alt|super/i);
  });
  ...
  // â”€â”€â”€ system-browser login handoff (Windows/Linux) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  //
