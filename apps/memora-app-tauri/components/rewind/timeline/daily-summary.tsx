...
const SUMMARY_CACHE_PREFIX = "memora:timeline-daily-summary:pi-v2:";
					...
					<DialogHeader>
						...
						<DialogDescription>
							{userToken
								...
								: "Daily summaries use your Memora account and the Memora Cloud auto model."}
						</DialogDescription>
					</DialogHeader>
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-xs text-muted-foreground">
										...
										Memora APIs. Relevant evidence is processed by your
										configured AI model.
									</p>
								</div>
							</div>
