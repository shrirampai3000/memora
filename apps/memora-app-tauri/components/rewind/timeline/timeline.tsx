...
// Maps app name â†’ "loaded" | "error" | Promise (in-flight).
...
export const TimelineSlider = ({
	...
	const frameBrowserUrls = useMemo(() => {
		...
		{
			// Pass 1: forward (in iteration order, which is newestâ†’oldest for descending frames)
			let carry = "";
			let lastBrowserApp = "";
							...
							>
								...
								{group.frames.map((frame, frameIdx) => {
									...
									const hasTags = frameTags.length > 0;
										...
										const endRadius = "6px"; // half of 12px height â†’ pill end
