...
const CHANGELOG_API = memoraWebUrl("/api/changelog?limit=50", "https://github.com/shrirampai3000/memora");
    ...
    <Dialog open={showChangelogDialog} onOpenChange={onClose}>
      <DialogContent className="w-11/12 max-w-3xl p-0 h-[80vh] overflow-hidden flex flex-col">
        <div className="px-6 pt-6 pb-4 border-b border-border flex items-center justify-between">
          ...
          <a
            href={memoraWebUrl("/changelog", "https://github.com/shrirampai3000/memora")}
            target="_blank"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {loading ? (
            ...
            <div className="text-sm text-muted-foreground font-mono">
              ...
              >
                github.com/shrirampai3000/memora/changelog
              </a>
            </div>
          )}
        </div>
