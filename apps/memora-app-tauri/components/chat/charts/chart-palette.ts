 ...
 * lightness, adjacent Î”L â‰¥ 0.06, and the near-surface step clearing 2:1.
...
/**
 * Series slots, separated by lightness. Ordered dark â†’ light in light mode so
...
/**
 * Magnitude ramp for heatmap cells, ordered low â†’ high. Unlike the series ramp
