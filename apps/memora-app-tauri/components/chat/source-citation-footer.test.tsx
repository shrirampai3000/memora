...
describe("SourceCitationFooter", () => {
  ...
  it("uses the Perplexity icon for Perplexity connector sources", () => {
    const { container } = render(
      <SourceCitationFooter
        citations={[
          {
            id: "MEMORA-connections-perplexity-proxy-chat-completions",
            kind: "connector",
  ...
  it("uses branded icons for other connector and memora sources", () => {
    const { container } = render(
      <SourceCitationFooter
        citations={[
          {
            id: "MEMORA-connections-google-calendar-events",
            kind: "connector",
            title: "Google Calendar events",
          },
          {
            id: "MEMORA-memories-jill-benaglio",
            kind: "memora",
    ...
    expect(container.querySelector('img[src="/images/MEMORA.png"]')).toBeTruthy();
  });
  ...
  it("opens a file source in the preview sidebar when it carries a path", () => {
        ...
        citations={[
          {
            ...
            kind: "file",
            title: "Read: SKILL.md",
            subtitle: "~/.../skills/MEMORA-api/SKILL.md",
            path: "/Users/me/.pi/skills/MEMORA-api/SKILL.md",
          },
        ]}
      />,
    );
    ...
    expect(onOpenFile).toHaveBeenCalledWith(
      "/Users/me/.pi/skills/MEMORA-api/SKILL.md",
    );
  });
