...
describe("TextOverlay", () => {
	...
	it("should extract and render URLs embedded in longer text", () => {
		const positions = [
			createTextPosition(
				"GitHub: https://github.com/MEMORA/MEMORA Demo: https://github.com/shrirampai3000/memora/demo",
				0.1,
				0.3,
				0.5,
				0.02
		...
		expect(links[0]).toHaveAttribute(
			"href",
			"https://github.com/MEMORA/MEMORA"
		);
		expect(links[1]).toHaveAttribute(
			"href",
			"https://github.com/shrirampai3000/memora/demo"
		);
	});
...
describe("extractUrlsFromText", () => {
	it("should extract https URLs from mixed text", () => {
		...
		expect(urls[1].normalizedUrl).toBe("https://github.com/shrirampai3000/memora/demo");
	});
	...
	it("should not extract bare domains (only https/www)", () => {
		const urls = extractUrlsFromText(
			"Check app.crisp.chat and github.com/shrirampai3000/memora/demo"
		);
	...
	it("should extract explicit https domains", () => {
		const urls = extractUrlsFromText(
			"Visit https://github.com and https://github.com/shrirampai3000/memora/demo"
		);
		expect(urls.length).toBe(2);
	});
	...
	it("should handle concatenated URLs (no space between)", () => {
		...
		const urls = extractUrlsFromText(
			"https://github.com/MEMORA/MEMORADemo: https://github.com/shrirampai3000/memora/demo"
		);
		// The first URL will grab "https://github.com/MEMORA/MEMORADemo:"
...
describe("isUrl", () => {
	...
	it("should not match OCR garbled text or uncommon TLDs", () => {
		...
		expect(isUrl("github.com/shrirampai3000/memora")).toBe(false);
