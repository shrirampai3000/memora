...
mod tests {
    ...
    /// the window SHOULD still be returned â€” that's the legitimate merge
    ...
    /// for merge â€” those aren't user-initiated stops.
    #[tokio::test]
    ...
    async fn explicit_stop_then_new_meeting_does_not_merge() {
        ...
        // Meeting A â€” user joins a Google Meet in Arc, talks, hits stop.
        let a = db
        ...
        // It calls find_recent_meeting_for_app â€” must return None so the
        ...
        // Caller falls through to insert_meeting â†’ fresh id.
        let b = db
