...
//!   3. Closing the existing open row releases the slot â€” a new meeting
...
mod tests {
    ...
    async fn migration_heals_pre_existing_duplicate_open_rows() {
        ...
        // The highest-id row survives â€” it's the most recent record and
    ...
    async fn closing_the_open_row_releases_the_slot() {
        ...
        // Starting a brand-new meeting must succeed â€” the index only
