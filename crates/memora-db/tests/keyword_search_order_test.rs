...
mod tests {
    ...
    use memora_db::{DatabaseManager, OcrEngine, Order};
    use std::sync::Arc;
    ...
    async fn test_keyword_search_sorted_by_timestamp_descending() {
        ...
        // They differ in timestamp â€” we verify results come back newest-first.
        ...
        // FTS is now indexed by AFTER INSERT triggers â€” no manual indexing needed
        ...
        // Frame B (10 min ago) â†’ Frame C (30 min ago) â†’ Frame A (60 min ago)
