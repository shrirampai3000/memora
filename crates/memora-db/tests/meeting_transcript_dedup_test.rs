...
//! same audio within Â±15s. That match MUST be scoped to capture direction:
...
//! merely lands within 15s of the user talking â€” silently dropping the audience
...
mod tests {
    ...
    async fn dense_input_live_does_not_suppress_backfilled_output() {
        ...
        // The user (primary speaker) â€” a dense run of input live finals.
        for i in 0..5 {
        ...
        // landing 3s after one of the user's input live finals â€” i.e. well
        // within the Â±15s window.
        let out_chunk = db
            .insert_audio_chunk(
        ...
        // A background *input* row within 15s of an input live final â€” this one
