...
const CHILD_ENV: &str = "MEMORA_WAL_CHAOS_CHILD";
const DB_ENV: &str = "MEMORA_WAL_CHAOS_DB";
const MARKER_ENV: &str = "MEMORA_WAL_CHAOS_MARKER";
const PHASE_ENV: &str = "MEMORA_WAL_CHAOS_PHASE";
...
#[tokio::test]
#[ignore = "manual post-app E2E verification of MEMORA_WAL_CHAOS_DB"]
async fn verify_existing_database_after_app_e2e() {
    let db_path = std::env::var(DB_ENV).expect("set MEMORA_WAL_CHAOS_DB");
