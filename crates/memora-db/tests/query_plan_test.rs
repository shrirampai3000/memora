...
//! hardware, dataset sizes, and timing â€” unlike wall-clock benchmarks.
...
mod query_plan_tests {
    ...
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // Search queries â€” the main read hot path
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    async fn test_is_null_or_defeats_timestamp_index() {
        ...
        if !is_null_uses_range && direct_uses_range {
            // IS NULL OR prevents range bounds â€” confirmed anti-pattern.
    ...
    async fn test_batch_insert_write_lock_minimized() {
        ...
        // Insert 20 frames via batch â€” this should work with semaphore(1)
    ...
    async fn test_concurrent_reads_dont_block_writes() {
        ...
        let result = timeout(Duration::from_secs(5), async {
            ...
            // Now do a write â€” should also be fast since read didn't hold semaphore
            let windows = vec![FrameWindowData {
        ...
        assert!(
            result.is_ok(),
            "Concurrent read + write timed out â€” possible deadlock or excessive blocking"
        );
    }
    ...
    // small pending set via the partial index idx_frames_snapshot_pending â€”
    // NOT scan the whole frames table. Regressing to a scan makes the query
    // O(total frames), which grew to a 10â€“20s stall in the field and starved
    ...
    async fn test_snapshot_compaction_query_uses_partial_index() {
        ...
        // is "SCAN frames USING INDEX idx_frames_snapshot_pending" â€” a *full
