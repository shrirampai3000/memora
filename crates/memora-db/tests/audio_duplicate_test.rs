...
///
/// Run with: cargo test --package memora-db --test audio_duplicate_test -- --nocapture
#[cfg(test)]
mod tests {
    use memora_db::{AudioDevice, DatabaseManager, DeviceType};
    ...
    async fn test_cross_device_exact_same_content() {
        ...
        println!("âœ“ Cross-device exact duplicate was correctly rejected");
    }
    ...
    async fn test_cross_device_short_contained_in_long() {
        ...
        println!("âœ“ Short-in-long cross-device duplicate was correctly rejected");
    }
    ...
    async fn test_cross_device_whisper_variations() {
        ...
        println!("âœ“ Whisper variation cross-device duplicate was correctly rejected");
    }
    ...
    async fn test_regression_production_logs_scenario() {
        ...
        println!("âœ“ REGRESSION TEST PASSED: Production duplicate scenario is now fixed");
    }
    ...
    async fn test_cross_device_different_content_allowed() {
        ...
        println!("âœ“ Different content across devices was correctly allowed");
    }
    ...
    async fn test_unique_constraint_exists() {
        ...
        println!("âœ“ UNIQUE constraint idx_audio_transcription_chunk_text exists");
    }
    ...
    async fn test_same_chunk_duplicate_prevented() {
        ...
        assert_eq!(count, 1);
        println!("âœ“ Same-chunk duplicate was correctly rejected");
    }
    ...
    async fn test_different_transcriptions_same_chunk_allowed() {
        ...
        let count = db.count_audio_transcriptions(chunk_id).await.unwrap();
        assert_eq!(count, 2);
        println!("âœ“ Different transcriptions for same chunk are allowed");
    }
    ...
    async fn test_short_phrases_handled_correctly() {
        ...
        println!("âœ“ Short phrases handled without error");
    }
    ...
    async fn test_empty_transcription_skipped() {
        ...
        println!("âœ“ Empty transcription correctly skipped");
    }
    ...
    async fn test_rapid_inserts_deduplicated() {
        ...
        println!("âœ“ Rapid consecutive duplicates correctly deduplicated (1 of 5 inserted)");
    }
    ...
    async fn test_full_deduplication_behavior() {
        ...
        println!("\nâœ“ All deduplication scenarios working correctly");
        println!("=== TEST COMPLETE ===\n");
    }
}

/// MEMORA-CLI-SN: the cross-device dedup pre-check runs a 50-row scan on
/// the *read* pool for every single transcription insert, and its failure used
/// to abort the whole call with `?` â€” before the write was ever attempted.
///
...
mod dedup_check_is_not_load_bearing {
    use memora_config::DbConfig;
    use memora_db::{AudioDevice, DatabaseManager, DeviceType};

    /// Starve the read pool and leave the write pool alone â€” the exact
    ...
    async fn a_starved_read_pool_does_not_lose_the_transcription() {
        ...
        tokio::spawn(async move {
            ...
            // first lookup genuinely fails â€” that is the production failure.
