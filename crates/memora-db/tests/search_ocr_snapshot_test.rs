...
//! - #2339: search() double-applied offset (SQL + Rust skip) â€” pages beyond first empty
...
mod tests {
    ...
    async fn test_search_ocr_returns_snapshot_frames() {
        ...
        // Insert a snapshot frame (event-driven capture â€” no video_chunk)
        let frame_id = db
    ...
    async fn test_search_pagination_returns_page_two() {
        ...
        // Page 2: limit=2, offset=2 â€” was broken (returned empty)
        let page2 = db
            .search(
                "pagination",
                ContentType::OCR,
    ...
    async fn test_search_all_limit_exceeded() {
        ...
        // This assertion demonstrates the bug â€” it will FAIL because
    ...
    /// Bug: ContentType::All pagination is broken â€” page 2 returns 0 items.
    ///
    ...
    async fn test_search_all_pagination_wrong_page_two() {
        ...
        // skips 3, but each type only has 3 items â†’ nothing left)
        assert_eq!(
            page2.len(),
            3,
