...
mod tests {
    use chrono::Utc;
    use memora_db::{ContentType, DatabaseManager, OcrEngine};
    use std::sync::Arc;
    ...
    // =========================================================================
    // search_ocr â€” app_name with dots
    // =========================================================================
    ...
    async fn test_search_ocr_app_name_with_dots() {
        ...
        // Search with app_name containing a dot â€” must NOT cause FTS5 syntax error
        let results = db
            .search(
                "",
                ContentType::OCR,
    ...
    // =========================================================================
    // search_ocr â€” browser_url with dots
    // =========================================================================
    ...
    // =========================================================================
    // search_ocr â€” window_name with dots
    // =========================================================================
    ...
    // =========================================================================
    // count_search_results â€” dots in app_name
    // =========================================================================
    ...
    async fn test_count_search_results_app_name_with_dots() {
        ...
        // count_search_results is called in parallel with search â€” must also handle dots
        let count = db
    ...
    // =========================================================================
    // search_accessibility â€” app_name with dots
    // =========================================================================
    ...
    // =========================================================================
    // search (ContentType::All) â€” the full endpoint path
    // =========================================================================
    ...
    async fn test_search_all_types_dotted_app_name() {
        ...
        // ContentType::All â€” exercises ALL search sub-functions
        let results = db
            .search(
                "",
                ContentType::All,
    ...
    async fn test_search_text_query_with_dots() {
        ...
        // Text query with dots â€” sanitize_fts5_query should handle this
        let results = db
            .search(
                "zoom.us",
                ContentType::OCR,
    ...
    fn test_sanitize_fts5_query_dots() {
        use memora_db::text_normalizer::sanitize_fts5_query;
    ...
    fn test_value_to_fts5_column_query() {
        use memora_db::text_normalizer::value_to_fts5_column_query;
