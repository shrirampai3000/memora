...
fn sqlite_lifecycle_has_one_owner_per_physical_database() {
    ...
    for path in files {
        ...
        if !path.ends_with("memora-secrets/src/store.rs")
        ...
        if source.contains("SecretStore::new_with_database_error_hook")
            && !path.ends_with("memora-secrets/src/store.rs")
        {
    ...
    let secrets = production_source(&repository.join("crates/memora-secrets/src/store.rs"));
...
fn credential_readers_resolve_the_existing_os_vault_key() {
    ...
    let readers = [
        (
            "apps/memora-app-tauri/src-tauri/src/server_core.rs",
            "open_for_data_dir_with_vault_key",
        ),
        (
            "apps/memora-app-tauri/src-tauri/src/oauth.rs",
            "open_for_data_dir_with_vault_key",
        ),
        (
            "apps/memora-app-tauri/src-tauri/src/chatgpt_oauth.rs",
            "open_for_data_dir_with_vault_key",
        ),
        (
            "apps/memora-app-tauri/src-tauri/src/pi.rs",
            "open_for_data_dir_with_vault_key",
        ),
        (
            "apps/memora-app-tauri/src-tauri/src/auth_token.rs",
            "get_key_for_read",
        ),
        (
        ...
        (
            "apps/memora-app-tauri/src-tauri/src/store.rs",
            "secrets::get_key()",
        ),
        (
            "crates/memora-engine/src/auth_key.rs",
            "open_for_data_dir_with_vault_key",
        ),
        (
            "crates/memora-engine/src/bin/memora-engine.rs",
            "open_for_data_dir_with_vault_key",
        ),
        (
            "crates/memora-engine/src/cli/connection.rs",
            "open_for_data_dir_with_vault_key",
        ),
        (
            "crates/memora-core/src/pipes/mod.rs",
            "open_for_data_dir_with_vault_key",
        ),
        (
            "crates/memora-connect/src/ics_calendar.rs",
            "keychain::get_key()",
        ),
    ];
