...
mod speaker_reassignment_tests {
    use memora_db::{AudioDevice, DatabaseManager, DeviceType, ReassignScope};
    ...
    async fn test_reassign_speakerless_chunk() {
        ...
        // backfill â€” reassigning them must work, not error out.
    ...
    /// on the given chunk (same text, same timestamp â€” what
