...
async fn output_search_finds_text_beyond_preview() {
    ...
    let id = db
        .insert_output(
            ...
            "/tmp/MEMORA/outputs/chat/session/brain-artifact-repro.md",
            body.len() as i64,
            Some(preview),
            None,
            None,
...
async fn output_search_respects_chat_display_source_filter() {
    ...
    let chat_id = db
        .insert_output(
            ...
            "markdown",
            None,
            "/tmp/MEMORA/outputs/chat/session/chat-artifact.md",
            128,
            Some("preview"),
            None,
            None,
    ...
    let pipe_id = db
        .insert_output(
            ...
            "markdown",
            None,
            "/tmp/MEMORA/outputs/pipe/pipe-a/pipe-artifact.md",
            128,
            Some("preview"),
            None,
            None,
...
async fn deleting_output_removes_search_document() {
    ...
    let id = db
        .insert_output(
            ...
            "markdown",
            None,
            "/tmp/MEMORA/outputs/chat/session/deleted-artifact.md",
            128,
            Some("preview"),
            None,
            None,
...
async fn output_search_paginates_across_many_indexed_artifacts() {
    ...
    for i in 0..artifact_count {
        ...
        let path = format!("/tmp/MEMORA/outputs/chat/scale/artifact-{i:04}.md");
        let id = db
            .insert_output(
                "scale-chat-session",
                "chat",
...
async fn reindexing_one_output_preserves_other_search_documents() {
    ...
    let first_id = db
        .insert_output(
            ...
            "markdown",
            None,
            "/tmp/MEMORA/outputs/chat/session/first-artifact.md",
            128,
            Some("preview"),
            None,
            None,
    ...
    let second_id = db
        .insert_output(
            ...
            "markdown",
            None,
            "/tmp/MEMORA/outputs/chat/session/second-artifact.md",
            128,
            Some("preview"),
            None,
            None,
...
async fn deleting_search_document_removes_direct_fts_row() {
    ...
    let id = db
        .insert_output(
            ...
            "markdown",
            None,
            "/tmp/MEMORA/outputs/chat/session/clear-artifact.md",
            128,
            Some("preview"),
            None,
            None,
...
async fn sentinel_search_document_marks_non_searchable_output_processed() {
    ...
    let id = db
        .insert_output(
            ...
            "png",
            None,
            "/tmp/MEMORA/outputs/pipe/image/artifact.png",
            128,
            Some("preview"),
            None,
            None,
...
async fn artifact_visibility_hides_structured_output_state_unless_requested() {
    ...
    let visible_id = db
        .insert_output(
            ...
            "saf",
            None,
            "/tmp/MEMORA/outputs/pipe/report/weekly.saf.json",
            128,
            Some("visible report"),
            None,
            Some("sop"),
    ...
    let internal_id = db
        .insert_output(
            ...
            "saf",
            None,
            "/tmp/MEMORA/outputs/pipe/time/structured-output.saf.json",
            128,
