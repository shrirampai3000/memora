...
//!
//! ```text
//! MEMORA_BENCH_SAMPLES=10 \
//! cargo test -p memora-db --release --test cancellation_performance_bench \
...
use memora_db::{CancellableReadConnection, SQLITE_PROGRESS_CHECK_OPS};
