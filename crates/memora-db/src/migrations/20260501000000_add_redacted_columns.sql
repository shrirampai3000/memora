...
--
-- Schema convention:
--   text_redacted     TEXT     â€” redacted version of the source column
--   redacted_at       INTEGER  â€” unix-seconds the redaction landed
--   redaction_version INTEGER  â€” name+version of the redactor that produced it
--
...
-- Accessibility-tree text â€” now lives at `frames.accessibility_text`.
...
-- redacted_at) compound â€” keyboard-only / clipboard-only fetches
