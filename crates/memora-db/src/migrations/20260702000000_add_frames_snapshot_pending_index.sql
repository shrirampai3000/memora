...
-- Snapshot compaction (crates/MEMORA-engine/src/snapshot_compaction.rs) and
...
-- rows to surface the few dozen still-pending ones â€” observed at 10â€“20s per
...
-- un-compacted frames (small, bounded by capture rate Ã— compaction lag), so
