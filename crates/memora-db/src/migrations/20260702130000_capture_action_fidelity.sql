...
--
-- 1. ui_events.element_ancestors â€” the clicked element's path in the window
...
--    button in the sidebar" vs "in the modal") â€” the #1 gap when replaying
--    recorded workflows step-by-step.
--
-- 2. display_layout â€” snapshots of the full display arrangement (per display:
...
--    element-tree bounds (normalized per-monitor) on multi-monitor setups â€”
