...
-- to the `frames` table so the new `MEMORA_redact::image::worker`
...
--
--   image_redacted_at       INTEGER  â€” unix-seconds the image redaction landed
--   image_redaction_version INTEGER  â€” model name+version that produced it
--   image_redaction_regions INTEGER  â€” # of regions that got blacked out (audit)
--
