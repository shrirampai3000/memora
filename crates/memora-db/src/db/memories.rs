...
impl DatabaseManager {
    ...
    //
    // The HTTP layer + background loop in memora-engine/src/memories_sync.rs
    ...
    // resolution (LWW) lives in memora-core::memories::sync and is pure;
    ...
    pub async fn upsert_synced_memory(
        ...
        let mut tx = self.begin_immediate_with_retry().await?;
        // SQLite's INSERT â€¦ ON CONFLICT (sync_uuid) is the cleanest path,
    ...
    /// Apply a remote tombstone â€” delete the local row matching the
    ...
    /// route to know whether to record a tombstone (skip if NULL â€”
    ...
    pub async fn list_memories(
        ...
        self.list_memories_with_search_deadline(
            query,
            source,
            tags_filter,
            min_importance,
    ...
    #[allow(clippy::too_many_arguments)]
    pub(super) async fn list_memories_for_search(
        &self,
        query: Option<&str>,
        source: Option<&str>,
        tags_filter: Option<&str>,
    ...
    #[allow(clippy::too_many_arguments)]
    async fn list_memories_with_search_deadline(
        &self,
        query: Option<&str>,
        source: Option<&str>,
        tags_filter: Option<&str>,
        ...
        let query = sqlx::query_as::<_, MemoryRecord>(sqlx::AssertSqlSafe(sql))
    ...
    pub async fn count_memories(
        ...
        self.count_memories_with_search_deadline(
            query,
            source,
            tags_filter,
            min_importance,
    ...
    #[allow(clippy::too_many_arguments)]
    pub(super) async fn count_memories_for_search(
        &self,
        query: Option<&str>,
        source: Option<&str>,
        tags_filter: Option<&str>,
    ...
    #[allow(clippy::too_many_arguments)]
    async fn count_memories_with_search_deadline(
        &self,
        query: Option<&str>,
        source: Option<&str>,
        tags_filter: Option<&str>,
