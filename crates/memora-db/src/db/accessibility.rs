...
impl DatabaseManager {
    ...
    /// `search_accessibility` â€” same return shape, different plan.
    ///
    ...
    /// excluded by the equality comparison â€” this is intentional. Issue #2436.
    #[allow(clippy::too_many_arguments)]
    ...
    pub async fn search_accessibility_visible_ordered(
        ...
        // Empty query is supported â€” drops the FTS join entirely so the
    ...
    /// This replaces the old accessibility table insert â€” data now lives in frames.
    pub async fn insert_accessibility_text(
        ...
        self.insert_snapshot_frame_with_ocr(
            ...
            Some(window_name),
            browser_url,
            None, // document_path â€” legacy a11y-only test helper
            false,
            None,
            Some(text_content),
            None,
