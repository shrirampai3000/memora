...
//!
//! Usage: cargo run --release -p memora-screen --example text_regions_probe -- <image> [...]
//!
//! Prints per-image timing, box count, covered area, and a JSON dump of the
//! boxes â€” the JSON matches the shape of the cv2 reference script used in the
//! #5054 benchmarks so outputs can be diffed directly for equivalence.

use memora_screen::text_regions::detect_text_regions;
