...
impl From<memora_db::CustomOcrConfig> for CustomOcrConfig {
    fn from(config: memora_db::CustomOcrConfig) -> Self {
        CustomOcrConfig {
...
impl From<CustomOcrConfig> for memora_db::CustomOcrConfig {
    fn from(config: CustomOcrConfig) -> Self {
        memora_db::CustomOcrConfig {
            api_url: config.api_url,
            api_key: config.api_key,
            timeout_ms: config.timeout_ms,
        }
