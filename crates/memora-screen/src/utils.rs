...
use memora_db::CustomOcrConfig as DBCustomOcrConfig;
...
impl From<OcrEngine> for memora_db::OcrEngine {
    fn from(val: OcrEngine) -> Self {
        match val {
            OcrEngine::Unstructured => memora_db::OcrEngine::Unstructured,
            OcrEngine::Tesseract => memora_db::OcrEngine::Tesseract,
            OcrEngine::WindowsNative => memora_db::OcrEngine::WindowsNative,
            OcrEngine::AppleNative => memora_db::OcrEngine::AppleNative,
            OcrEngine::Custom(config) => {
                memora_db::OcrEngine::Custom(DBCustomOcrConfig::from(config))
            }
        }
    }
}

impl From<memora_db::OcrEngine> for OcrEngine {
    fn from(engine: memora_db::OcrEngine) -> Self {
        match engine {
            memora_db::OcrEngine::Unstructured => OcrEngine::Unstructured,
            memora_db::OcrEngine::Tesseract => OcrEngine::Tesseract,
            memora_db::OcrEngine::WindowsNative => OcrEngine::WindowsNative,
            memora_db::OcrEngine::AppleNative => OcrEngine::AppleNative,
            memora_db::OcrEngine::Custom(config) => OcrEngine::Custom(config.into()),
        }
    }
}
