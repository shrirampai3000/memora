...
//!
//! Writes individual JPEG files to `~/.memora/data/YYYY-MM-DD/`
...
impl SnapshotWriter {
    ...
    ///
    /// - `base_dir`: root data directory (e.g., `~/.memora/data`)
    ...
    pub fn write(
        ...
        let _dip = memora_core::thread_priority::BackgroundWorkDip::new();
