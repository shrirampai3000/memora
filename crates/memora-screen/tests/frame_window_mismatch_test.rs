...
//!
//! Run with: cargo test -p memora-screen --test frame_window_mismatch_test -- --nocapture
    ...
    let capture1 = CaptureResult {
        ...
        windows: vec![
            ...
            WindowResult {
                ...
                window_name: "GitHub - MEMORA".to_string(),
                ocr_text: "MEMORA repository README".to_string(),
            },
        ],
    };
