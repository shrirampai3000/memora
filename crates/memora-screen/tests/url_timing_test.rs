...
//!
//! Run with: cargo test -p memora-screen --test url_timing_test -- --nocapture

use memora_screen::browser_utils::{strip_title_badge, titles_match};
    ...
    fn new() -> Self {
        Self {
            tabs: vec![
                ...
                ("GitHub - MEMORA", "https://github.com/MEMORA"),
...
async fn test_title_mismatch_rejects_cross_domain() {
    // Real cases from MEMORA data where URL was wrong
