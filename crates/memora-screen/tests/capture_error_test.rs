...
/// - MEMORA-CLI-1Z: "Failed to capture image for window TheBoringNotch"
/// - MEMORA-CLI-1Y: "Failed to capture image for window Grammarly Desktop"
/// - MEMORA-CLI-2: "GetFileVersionInfoSizeW failed: WIN32_ERROR(1813)"
///
...
fn test_problematic_apps_should_be_skipped() {
    ...
    let problematic_apps = vec![
        ...
        "Omiå½•å±ä¸“å®¶",       // Chinese screen recorder with overlay
    ];
