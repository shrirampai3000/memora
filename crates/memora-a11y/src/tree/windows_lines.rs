...
//! search side falls back to the paragraph bbox path automatically â€” same
...
//!    handling â€” same `LineBudget` from `tree::mod`.
...
/// walker. The search side renders the paragraph bbox as a fallback â€”
