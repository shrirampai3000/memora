...
//! memora-a11y: Cross-platform UI event capture for MEMORA
//!
//! This crate provides keyboard, mouse, and accessibility-based UI event capture
//! as a third modality for MEMORA, complementing vision (OCR) and audio.
//!
//! ## Features
//!
...
//!
//! ```rust,no_run
//! use memora_a11y::{UiRecorder, UiCaptureConfig};
//!
