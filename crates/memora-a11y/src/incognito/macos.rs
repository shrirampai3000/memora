...
//!
//! Arc is **not** handled here â€” Arc 1.138+ broke its AppleScript bridge
...
impl IncognitoDetector for MacOSIncognitoDetector {
    ...
    // Arc's is_url_incognito is no longer needed â€” AXIdentifier handles it.
}
...
mod tests {
    ...
    fn test_is_chromium_browser() {
        ...
        // Arc is NOT in the list â€” handled via AXIdentifier
