...
//! Pure logic â€” no I/O, no platform dependencies, fully unit-testable.
...
pub enum WalkTier {
    /// < 50ms avg â€” default behavior
    Light,
    /// 50â€“150ms avg â€” reduced frequency
    Moderate,
    /// 150â€“250ms avg â€” significantly reduced
    Heavy,
    /// > 250ms avg or repeated truncations â€” minimal walking (60s interval)
    Critical,
}
...
impl AppCost {
    ...
    fn compute_tier(&self) -> WalkTier {
        // Repeated truncations â†’ critical regardless of avg duration
...
///
/// Lives in the capture loop â€” one instance per monitor.
...
mod tests {
    ...
    fn test_light_app_not_throttled() {
        ...
        // Light apps just need 200ms between walks â€” our fake records have
