...
//!
//! Two modes:
//!   default            â€” ships defaults (capture_tree=false): the fixed behavior
//!   --capture-tree     â€” re-enables full-window tree walks (+ --interval-ms,
...
//!
//! Usage: cargo run -p memora-a11y --example windows_probe_harness -- \
//!            [--capture-tree] [--interval-ms 2000] [--duration-secs 120]

#[cfg(target_os = "windows")]
fn main() {
    use memora_a11y::events::EventData;
    use memora_a11y::{UiCaptureConfig, UiRecorder};
