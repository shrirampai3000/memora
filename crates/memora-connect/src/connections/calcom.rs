...
static OAUTH: OAuthConfig = OAuthConfig {
    ...
    // `SCHEDULE_READ`, not `AVAILABILITY_READ` â€” Cal.com's scope
...
static DEF: IntegrationDef = IntegrationDef {
    ...
    description: "Access Cal.com bookings and scheduling. Connected via OAuth â€” use GET https://api.cal.com/v2/... with Authorization: Bearer <access_token> and cal-api-version: 2024-08-13 header.",
    fields: &[],
};
...
impl Integration for CalCom {
    ...
    async fn test(
        ...
        let token = oauth::read_oauth_token_instance(secret_store, "calcom", None)
            .await
            .ok_or_else(|| anyhow!("not connected â€” use 'Connect with Cal.com' button"))?;
