...
//! - `get_events(hours_back, hours_ahead)` â€” fetch events in a time window
//! - `get_current_events()` â€” events happening right now
...
// Re-export so downstream crates (memora-engine's calendar routes) can
...
pub struct CalendarEvent {
    pub id: String,
    pub title: String,
    /// UTC time â€” use for comparisons and event bus serialization.
    pub start: DateTime<Utc>,
    /// UTC time â€” use for comparisons and event bus serialization.
    pub end: DateTime<Utc>,
    /// Local time â€” use for display formatting.
...
/// Thin wrapper around `eventkit::EventsManager` with MEMORA-specific additions.
...
impl MEMORACalendar {
    ...
    ///
    /// MEMORA only reads calendars/events, but EventKit does not offer a
    ...
    // â”€â”€ Calendar listing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Event fetching â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    fn fetch_events_with_attendees(
        ...
        // here: MEMORA reads existing calendar events, attendees, URLs, and
        ...
        match status {
            ...
            _ => {
                if Self::access_granted_this_session() {
                    warn!(
                        "calendar: os status is {} but access was granted this session â€” re-syncing and reading anyway",
                        status
                    );
                    self.reset();
                } else {
...
impl Default for MEMORACalendar {
    fn default() -> Self {
        Self::new()
    }
}

// â”€â”€ Meeting URL helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
mod tests {
    ...
    fn test_list_calendars() {
        if MEMORACalendar::authorization_status() != AuthorizationStatus::FullAccess {
