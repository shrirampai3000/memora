...
/// Flat accessibility node shape persisted by MEMORA today.
///
...
/// Diagnostics from adapting MEMORA's current text-oriented flat tree.
...
/// Convert MEMORA's current flattened accessibility nodes into a compact
...
/// with bounds that lie off-window is scrollback â€” exactly what suppression is
