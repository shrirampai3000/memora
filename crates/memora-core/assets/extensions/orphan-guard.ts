...
// Orphan guard: kills this bun process if the parent (MEMORA) dies.
// Without this, bun processes survive app exit/crash and accumulate.
//
// Two detection methods:
// 1. stdin close â€” parent death closes our stdin pipe
// 2. ppid poll â€” if parent PID changes to 1 (init/launchd), parent is dead
...
export default function (pi: ExtensionAPI) {
  ...
  // Method 1: stdin close detection â€” ONLY in RPC mode.
  ...
  const interval = setInterval(() => {
    try {
      ...
      // Also try kill(parentPid, 0) â€” throws if process doesn't exist
