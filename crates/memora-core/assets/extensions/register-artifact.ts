...
export default function (pi: ExtensionAPI) {
  ...
  if (!pipeName) {
    // Not running inside a pipe runtime â€” silently skip registration.
    return;
  }
  ...
  pi.registerTool({
    ...
    description:
      ...
      "the user should find later. The file must already exist on disk â€” use writeFile first if " +
    ...
    async execute(
      ...
      const authKey = process.env.MEMORA_LOCAL_API_KEY || "";
