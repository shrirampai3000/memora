...
//! current system default input to keep capture alive â€” and again when
...
pub enum AudioDeviceFallbackState {
    ...
    /// **no** other input device to fall back to â€” mic capture has stopped
...
/// subscribers can filter without inspecting the payload â€” same
...
impl AudioDeviceFallbackEvent {
    ...
    /// The pinned device is gone and there is nothing to fall back to â€”
