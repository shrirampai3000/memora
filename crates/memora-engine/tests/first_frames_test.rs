...
/// Setup test environment with real MEMORA database
...
#[tokio::test]
#[ignore = "requires real MEMORA data, run with --ignored"]
...
#[tokio::test]
#[ignore = "requires running MEMORA server, run with --ignored"]
