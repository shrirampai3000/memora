...
//! `voice` is the RMS-gated activity that fixed BUG-2 â€” a silent `(output)`
...
/// Back-date the live timer by 2 minutes â€” past the 30s native grace, but small
...
fn scenarios() -> Vec<Scenario> {
    ...
    vec![
        ...
        // stays alive â€” the keep-alive we must not regress.
        Scenario {
