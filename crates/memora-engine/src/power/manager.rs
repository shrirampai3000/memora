...
//! Power Manager â€” coordinates battery-aware behavior across subsystems.
//!
...
use memora_events::{send_event, PowerProfileChangedEvent, POWER_PROFILE_CHANGED_EVENT};
...
/// "battery critical at 100%" â€” the real trigger was OS Low Power Mode.
    ...
    tokio::spawn(async move {
        ...
        loop {
            ...
            if new_profile.capture_paused && current_name != ProfileName::FullPause {
                info!(
                    "battery critical (<=10%) â€” pausing all capture \
