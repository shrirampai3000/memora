...
//! Power profiles â€” parameter bundles for performance / balanced / saver modes.
//!
...
pub struct PowerProfile {
    ...
    // â”€â”€ Vision: event-driven capture â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    /// Frame difference threshold (0.0â€“1.0) for visual change detection.
    pub visual_change_threshold: f64,
    /// JPEG quality for snapshots (1â€“100).
    pub jpeg_quality: u8,

    // â”€â”€ Vision: adaptive FPS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    /// VAD minimum speech ratio â€” segments below this are skipped entirely.
    ...
    // â”€â”€ Capture pause â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Video encoding â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
impl PowerProfile {
    /// Full performance â€” used when on AC power.
    ...
    /// Balanced â€” used when on battery with >40% charge.
    ...
    /// Maximum battery saving â€” used when battery <=40% or user-forced.
    pub fn saver() -> Self {
        Self {
    ...
    /// Audio paused â€” used when battery <=20%.
    ...
    pub fn audio_paused() -> Self {
        Self {
            ...
            jpeg_quality: 40,
            fps_interval_multiplier: 4.0,
            // ratio=1.0 means no segment ever passes VAD â€” effectively off
    ...
    /// Full pause â€” used when battery <=10% or OS low-power mode is active.
    ...
    pub fn for_state(state: &PowerState, user_pref: PowerMode) -> Self {
        match user_pref {
            ...
            PowerMode::Auto => {
                ...
                // AC power â†’ full performance, UNLESS OS low-power mode is on.
                ...
                // Battery tier from actual charge level â€” this is the only
                ...
                let battery_profile = match state.battery_pct {
                    ...
                    // No battery info but not on AC â†’ balanced to be safe
                    None => Self::balanced(),
                };
...
mod tests {
    ...
    fn test_ac_with_os_low_power_drops_to_saver() {
        ...
        // it must also NOT stop capture entirely â€” Saver is the answer.
        let state = PowerState {
            on_ac: true,
            battery_pct: Some(80),
            thermal_state: ThermalState::Nominal,
    ...
    fn test_audio_paused_skips_screenshot_keeps_a11y() {
        // AudioPaused: no JPEG, no Whisper â€” but a11y tree walk continues.
    ...
    fn test_saver_still_takes_screenshots() {
        // Saver is NOT AudioPaused â€” it still writes snapshot rows,
