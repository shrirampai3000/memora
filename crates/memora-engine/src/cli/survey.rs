...
const SURVEY_BASE_URL: &str = "https://github.com/shrirampai3000/memora/survey/cli";
...
/// Handle `MEMORA survey` â€” opens the CLI usage survey in the browser.
pub async fn handle_survey_command() -> anyhow::Result<()> {
    let url = survey_url();

    println!();
    println!("  opening browser to the MEMORA CLI survey...");
    println!();
