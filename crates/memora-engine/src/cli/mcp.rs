...
use super::{McpCommand, OutputFormat};
    ...
    match command {
        McpCommand::Setup {
            ...
            let run_command = format!(
                "uv --directory {} run MEMORA-mcp --port {}",
            ...
            if should_download {
                ...
                let repo = "MEMORA";
                let branch = "main";
                let target_dir = "packages/MEMORA-mcp";
...
async fn download_mcp_directory(
    ...
    headers.insert(USER_AGENT, HeaderValue::from_static("MEMORA-cli"));
