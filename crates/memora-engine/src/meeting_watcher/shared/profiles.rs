...
pub struct MeetingDetectionProfile {
    ...
    /// for both messaging and meetings under one process â€” most notably Webex,
    ...
    /// AX tree before starting a meeting â€” mic-hold + app identity alone is not
    ...
    let mut profiles = vec![
        ...
        MeetingDetectionProfile {
            ...
            call_signals: vec![
                ...
                // "Mute mic (â‡§ âŒ˜ M)" is only present during an active call.
                CallSignal::RoleWithName {
                    role: "AXCheckBox",
        ...
        // Zoom Desktop
        // Note: Zoom on macOS does NOT expose AXWindow â€” only AXMenuBar.
        ...
        // https://github.com/MEMORA/MEMORA/issues/2561
        // Now only real call control signals (leave, end meeting, Zoom Meeting
        // window title, etc.) trigger detection.
        // NOTE: "end" alone removed as signal â€” too broad, matches "Send",
        // "Append", "Calendar End", etc. Use "end meeting" instead.
        // NOTE: onMuteAudio:/onMuteVideo: removed â€” mute controls can appear
        ...
        MeetingDetectionProfile {
            ...
            call_signals: vec![
                ...
                // exposes NO named buttons â€” all toolbar controls are unnamed.
                ...
                // toolbar, so a call that STARTS already-sharing is never detected â€”
        ...
        // Google Meet (browser)
        // NOTE: "google meet" removed from url_patterns â€” it's too broad and matches
        ...
        // NOTE: Ctrl+D / Cmd+D removed â€” these are the browser bookmark shortcut
        // and cause false positives when any browser element exposes âŒ˜D in its AX tree.
        MeetingDetectionProfile {
            app_identifiers: AppIdentifiers {
                macos_app_names: &[],
        ...
        MeetingDetectionProfile {
            ...
            call_signals: vec![
                ...
                // `appMenuLeaveTeam` â€” which the previous `AutomationIdContains
        ...
        // Discord in browser â€” require BOTH "Voice Connected" bar AND "Disconnect"
        ...
        // Signal â€” voice/video calls
        // macOS: Signal is an Electron app whose AX tree is opaque â€” buttons
        ...
        // WhatsApp â€” voice/video calls
        // requires_call_signal: true â€” WhatsApp grabs the mic for voice notes
        ...
        // Telegram â€” voice/video calls
        // requires_call_signal: true â€” Telegram grabs the mic for voice notes
        // just like a call; without this gate, every voice note starts a phantom
        // meeting (#4776).
        MeetingDetectionProfile {
            app_identifiers: AppIdentifiers {
        ...
        // Generic fallback â€” catches apps like Skype, Around, Whereby, etc.
        MeetingDetectionProfile {
            app_identifiers: AppIdentifiers {
                macos_app_names: &[
                    "skype",
                ...
                browser_url_patterns: &[
                    ...
                    "livestorm.co",
                    "ping.gg",
                    // Cal.com is primarily a scheduling product â€” its booking
