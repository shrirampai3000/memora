...
//! monitors. OFF by default â€” when focus resolution fails or is disabled,
...
impl MonitorIdentity {
    ...
    pub fn from_monitor(monitor: &memora_screen::monitor::SafeMonitor) -> Self {
...
/// Focus event â€” emitted whenever the tracker detects a change.
