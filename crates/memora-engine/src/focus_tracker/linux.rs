...
//! Linux focus tracker â€” minimal safe default.
//!
...
//!   Xrandr-per-output mapping to translate window geometry â†’ monitor.
...
//! Linux get no CPU savings yet â€” but they also don't get silent capture
...
impl LinuxFocusTracker {
    /// Start â€” always succeeds. Emits a single `Unknown` event so any
