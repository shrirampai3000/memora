...
//!
//! These endpoints proxy to the MEMORA.pe Supabase backend, allowing users
...
/// Base URL for the MEMORA registry API.
fn api_base_url() -> String {
    std::env::var("MEMORA_API_BASE_URL").unwrap_or_else(|_| "https://github.com/shrirampai3000/memora".to_string())
}
...
pub async fn pipe_store_install(
    ...
    let connections: Vec<String> = memora_core::pipes::parse_frontmatter(&source_md)
