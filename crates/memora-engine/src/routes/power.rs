...
//!
//! `GET  /power` â€” current power state, active profile, and user preference.
//! `POST /power` â€” set user power mode preference (auto / performance / battery_saver).
...
/// GET /power â€” return current power status.
...
/// POST /power â€” set user power mode preference.
