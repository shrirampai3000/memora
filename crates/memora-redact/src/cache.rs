...
//!
//! MEMORA captures repeat enormously: the same window title /
...
/// Default capacity. ~10 KiB per entry â†’ ~30 MiB at full size. Cheap.
...
/// Cache key â€” SHA256(text || redactor_name || redactor_version).
