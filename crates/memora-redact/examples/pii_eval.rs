...
//!   1. RECALL  â€” generate checksum-valid IDs per category and measure the
...
//!      generator bug can't inflate recall â€” every "positive" is a value
//!      the validator certifies.
//!   2. HARD NEGATIVES â€” strings that look ID-ish but are not valid IDs
...
//!   3. REAL-TEXT FP â€” scan a real source tree (default: `crates`) line by
...
use memora_redact::adapters::national_id as nid;
use memora_redact::adapters::regex::redact_one;
