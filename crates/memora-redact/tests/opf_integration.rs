...
use memora_redact::{Redactor, SpanLabel};
...
async fn redacts_person_email_phone() {
    ...
    let cases: &[(&str, &[SpanLabel])] = &[
        (
            "Welcome | Marcus Chen â€” Confluence",
            &[SpanLabel::Person],
        ),
        (
            "Outlook â€” Inbox â€” marcus.chen@helios-ai.io",
            &[SpanLabel::Email],
        ),
        (
...
async fn batch_preserves_order() {
    ...
    let texts = vec![
        ...
        "Cursor â€” Welcome".to_string(),
        "Outlook â€” Inbox â€” marcus.chen@helios-ai.io".to_string(),
    ];
