...
//! Native win32 overlay pill for MEMORA.
//!
...
//! No WebView2, no toolkit, no second runtime â€” the whole overlay is this crate
//! plus the OS.
//!
//! macOS counterpart: `apps/memora-app-tauri/src-tauri/swift/shortcut_reminder.swift`.
//!
//! # Layering
//!
