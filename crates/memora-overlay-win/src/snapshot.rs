...
pub enum Backdrop {
    /// Nothing â€” a transparent PNG, for compositing elsewhere.
    Transparent,
    Solid([f32; 3]),
...
/// forced opaque â€” otherwise the desktop would composite as fully transparent.
...
/// it â€” that is what proves the layered window is really on screen.
...
/// Render the drag stage â€” the dim and the four landing targets â€” over a
