...
/// report â€” either because it is a status cell rather than a button, or because
...
pub fn action_for(state: &OverlayState, control: Control) -> Option<String> {
    let fixed = match control {
        ...
        // The audio meter is a status cell, not a button â€” same as the mac
        ...
        Control::NotificationAction0 | Control::NotificationAction1 => {
            ...
            // The pill never interprets the payload â€” it hands the action's own
...
mod tests {
    ...
    fn the_first_notification_button_is_the_primary_one() {
        // Button 0 is drawn rightmost and is the primary â€” clicking "open note"
