...
/// shortcut_reminder.swift â€” this is the shape people recognise as the meter.
...
/// looks busy and dishonest â€” it animates when nothing is being said.
#[derive(Debug, Clone)]
...
impl Equalizer {
    ...
    /// True while any bar is still settling â€” the redraw timer stops when this
...
mod tests {
    ...
    fn a_held_level_holds_its_height() {
        ...
        // constant level is the Â±1.5px jitter and nothing more â€” anything
