...
Chrome/Chromium extension that connects your browser to MEMORA, enabling pipes to execute JavaScript in browser tabs.

## How it works

1. Extension connects to MEMORA's local server via WebSocket (`ws://localhost:3030/browser/ws`)
...
- Sync ChatGPT/Claude conversation history into MEMORA memories
