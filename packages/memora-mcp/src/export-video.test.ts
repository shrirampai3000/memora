...
// WebSocket â€” those were removed along with the legacy /frames/export endpoint.
        ...
        req.on("end", () => {
          ...
          res.end(
            JSON.stringify({
              ...
              output_path: parsed.output_path || "/tmp/MEMORA/exports/export_20260101_000000.mp4",
              frame_count: 42,
              audio_chunk_count: 7,
              duration_secs: 123.4,
